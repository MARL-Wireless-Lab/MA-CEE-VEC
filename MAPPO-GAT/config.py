...
def get_config():
    ...
    # env parameters
    parser.add_argument('--env', help='environment ID', default='AUTOVANET-C-v1')
    ...
    parser.add_argument("--use_feature_normalization", action='store_false', default=False,
    ...
    parser.add_argument("--opti_eps", type=float, default=2e-5,
                        help='RMSprop optimizer epsilon (default: 1e-5)')
    parser.add_argument("--weight_decay", type=float, default=0)
    # ppo parameters
    parser.add_argument("--ppo_epoch", type=int, default=50,
    ...
    parser.add_argument("--huber_delta", type=float, default=10, help=" coefficience of huber loss.")
    # run parameters
