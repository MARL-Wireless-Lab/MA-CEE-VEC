...
class VARunner(Runner):
    ...
    def run(self, vari):
        ...
        for episode in tqdm(range(episodes)):
            ...
            for step in range(self.episode_length):
                ...
                obs, share_obs, rewards, data, energy, success, dones, new_adj, delay, delay_success, energy_success = self.envs.step(actions)
                ...
                data = obs, share_obs, rewards, dones, values, actions, action_log_probs, rnn_states, rnn_states_critic, adj
    ...
    def warmup(self):
        # reset env
        obs, share_obs, adj = self.envs.reset()
        self.buffer.share_obs[0] = share_obs.copy()
        self.buffer.obs[0] = obs.copy()
        self.buffer.matrix[0] = adj.copy()
        return adj
    ...
    def insert(self, data):
        ...
        values, actions, action_log_probs, rnn_states, rnn_states_critic, next_matrix = data
        ...
        self.buffer.insert(share_obs, obs, rnn_states, rnn_states_critic,
                           actions, action_log_probs, values, rewards, next_matrix)
