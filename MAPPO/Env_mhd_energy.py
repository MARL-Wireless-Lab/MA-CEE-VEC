...
class AUTOVANET_CV1(gym.Env):
    ...
    def step(self, actions):
        ...
        for i in range(self.car_num):
            action[i][0] = actions[i][0] // self.P_j_level
            action[i][1] = actions[i][0] % self.P_j_level
        done = False
        ...
        return self.state, self.state, reward, Data_bit / 1048576, Energy, success / self.car_num, done, Delay, delay_success / self.car_num, energy_success / self.car_num
