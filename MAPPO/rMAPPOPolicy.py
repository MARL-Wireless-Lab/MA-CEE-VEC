...
class R_MAPPOPolicy:
    ...
    def get_actions(self, cent_obs, obs, actions_onehot, rnn_states_actor, rnn_states_critic,
                    deterministic=False):
        """
        ...
        actions, action_log_probs, rnn_states_actor = self.actor(inputs,
                                                                 rnn_states_actor,
                                                                 deterministic)

        values, rnn_states_critic = self.critic(inputs, rnn_states_critic)
